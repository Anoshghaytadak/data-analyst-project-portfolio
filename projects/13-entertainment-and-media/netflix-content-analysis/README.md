...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Netflix Content Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/netflix-content-analysis/netflix_content_analysis.py
```
