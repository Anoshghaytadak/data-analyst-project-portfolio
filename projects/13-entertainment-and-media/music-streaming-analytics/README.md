...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Music Streaming Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/music-streaming-analytics/music_streaming_analytics.py
```
