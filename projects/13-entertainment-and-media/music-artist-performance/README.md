...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Music Artist Performance**?
...
```bash
python3 projects/13-entertainment-and-media/music-artist-performance/music_artist_performance.py
```
