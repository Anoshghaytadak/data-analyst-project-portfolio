...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hollywood Movie Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/hollywood-movie-analytics/hollywood_movie_analytics.py
```
