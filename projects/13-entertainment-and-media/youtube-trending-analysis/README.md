...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **YouTube Trending Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/youtube-trending-analysis/youtube_trending_analysis.py
```
