...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Entertainment KPI Dashboard**?
...
```bash
python3 projects/13-entertainment-and-media/entertainment-kpi-dashboard/entertainment_kpi_dashboard.py
```
