...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Amazon Prime Content Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/amazon-prime-content-analysis/amazon_prime_content_analysis.py
```
