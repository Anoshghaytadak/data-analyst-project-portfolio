...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Bollywood Movie Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/bollywood-movie-analytics/bollywood_movie_analytics.py
```
