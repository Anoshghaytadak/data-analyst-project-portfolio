...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Director Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/director-analytics/director_analytics.py
```
