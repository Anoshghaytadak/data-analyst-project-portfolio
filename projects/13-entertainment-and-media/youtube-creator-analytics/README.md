...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **YouTube Creator Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/youtube-creator-analytics/youtube_creator_analytics.py
```
