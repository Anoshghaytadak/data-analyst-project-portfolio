...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Movie Rating Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/movie-rating-analysis/movie_rating_analysis.py
```
