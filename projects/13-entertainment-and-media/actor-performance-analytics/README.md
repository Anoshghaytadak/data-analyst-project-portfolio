...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Actor Performance Analytics**?
...
```bash
python3 projects/13-entertainment-and-media/actor-performance-analytics/actor_performance_analytics.py
```
