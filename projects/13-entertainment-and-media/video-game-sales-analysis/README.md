...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Video Game Sales Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/video-game-sales-analysis/video_game_sales_analysis.py
```
