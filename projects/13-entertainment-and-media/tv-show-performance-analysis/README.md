...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **TV Show Performance Analysis**?
...
```bash
python3 projects/13-entertainment-and-media/tv-show-performance-analysis/tv_show_performance_analysis.py
```
