...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Property Investment Analysis**?
...
```bash
python3 projects/16-real-estate/property-investment-analysis/property_investment_analysis.py
```
