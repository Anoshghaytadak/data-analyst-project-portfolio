...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Property Rental Yield Analysis**?
...
```bash
python3 projects/16-real-estate/property-rental-yield-analysis/property_rental_yield_analysis.py
```
