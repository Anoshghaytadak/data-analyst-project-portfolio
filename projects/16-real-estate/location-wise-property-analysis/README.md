...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Location-wise Property Analysis**?
...
```bash
python3 projects/16-real-estate/location-wise-property-analysis/location_wise_property_analysis.py
```
