...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Housing Demand Analysis**?
...
```bash
python3 projects/16-real-estate/housing-demand-analysis/housing_demand_analysis.py
```
