...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Broker Performance Analysis**?
...
```bash
python3 projects/16-real-estate/broker-performance-analysis/broker_performance_analysis.py
```
