...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Real Estate Customer Analytics**?
...
```bash
python3 projects/16-real-estate/real-estate-customer-analytics/real_estate_customer_analytics.py
```
