...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Real Estate Sales Dashboard**?
...
```bash
python3 projects/16-real-estate/real-estate-sales-dashboard/real_estate_sales_dashboard.py
```
