...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Real Estate KPI Dashboard**?
...
```bash
python3 projects/16-real-estate/real-estate-kpi-dashboard/real_estate_kpi_dashboard.py
```
