...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **House Price Prediction**?
...
```bash
python3 projects/16-real-estate/house-price-prediction/house_price_prediction.py
```
