...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Residential Property Analytics**?
...
```bash
python3 projects/16-real-estate/residential-property-analytics/residential_property_analytics.py
```
