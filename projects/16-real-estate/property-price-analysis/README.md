...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Property Price Analysis**?
...
```bash
python3 projects/16-real-estate/property-price-analysis/property_price_analysis.py
```
