...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Rental Price Analysis**?
...
```bash
python3 projects/16-real-estate/rental-price-analysis/rental_price_analysis.py
```
