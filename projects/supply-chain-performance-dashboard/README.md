...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supply Chain Performance Dashboard**?
...
```bash
python3 projects/supply-chain-performance-dashboard/supply_chain_performance_dashboard.py
```
