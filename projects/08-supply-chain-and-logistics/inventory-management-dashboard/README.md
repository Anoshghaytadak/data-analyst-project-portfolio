...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Inventory Management Dashboard**?
...
```bash
python3 projects/08-supply-chain-and-logistics/inventory-management-dashboard/inventory_management_dashboard.py
```
