...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Order Fulfillment Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/order-fulfillment-analysis/order_fulfillment_analysis.py
```
