...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Inventory Turnover Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/inventory-turnover-analysis/inventory_turnover_analysis.py
```
