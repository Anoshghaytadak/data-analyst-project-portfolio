...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supply Chain KPI Dashboard**?
...
```bash
python3 projects/08-supply-chain-and-logistics/supply-chain-kpi-dashboard/supply_chain_kpi_dashboard.py
```
