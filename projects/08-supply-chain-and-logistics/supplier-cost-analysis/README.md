...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supplier Cost Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/supplier-cost-analysis/supplier_cost_analysis.py
```
