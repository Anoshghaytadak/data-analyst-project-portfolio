...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Last-Mile Delivery Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/last-mile-delivery-analysis/last_mile_delivery_analysis.py
```
