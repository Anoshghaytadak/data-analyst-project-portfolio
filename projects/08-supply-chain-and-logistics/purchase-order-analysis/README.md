...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Purchase Order Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/purchase-order-analysis/purchase_order_analysis.py
```
