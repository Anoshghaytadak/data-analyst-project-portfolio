...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Warehouse Analytics**?
...
```bash
python3 projects/08-supply-chain-and-logistics/warehouse-analytics/warehouse_analytics.py
```
