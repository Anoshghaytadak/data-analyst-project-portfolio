...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Vendor Quality Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/vendor-quality-analysis/vendor_quality_analysis.py
```
