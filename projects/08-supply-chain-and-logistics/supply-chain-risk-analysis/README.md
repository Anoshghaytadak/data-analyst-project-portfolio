...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supply Chain Risk Analysis**?
...
```bash
python3 projects/08-supply-chain-and-logistics/supply-chain-risk-analysis/supply_chain_risk_analysis.py
```
