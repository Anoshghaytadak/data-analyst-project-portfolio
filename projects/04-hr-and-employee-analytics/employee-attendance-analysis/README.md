...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Attendance Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-attendance-analysis/employee_attendance_analysis.py
```
