...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Recruitment Source Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/recruitment-source-analysis/recruitment_source_analysis.py
```
