...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Salary Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-salary-analysis/employee_salary_analysis.py
```
