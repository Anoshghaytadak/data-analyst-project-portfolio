...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Tenure Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-tenure-analysis/employee_tenure_analysis.py
```
