...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **HR KPI Dashboard**?
...
```bash
python3 projects/04-hr-and-employee-analytics/hr-kpi-dashboard/hr_kpi_dashboard.py
```
