...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Attrition Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-attrition-analysis/employee_attrition_analysis.py
```
