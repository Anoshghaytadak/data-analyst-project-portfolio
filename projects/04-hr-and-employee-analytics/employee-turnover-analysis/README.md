...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Turnover Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-turnover-analysis/employee_turnover_analysis.py
```
