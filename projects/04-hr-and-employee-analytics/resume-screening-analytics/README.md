...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Resume Screening Analytics**?
...
```bash
python3 projects/04-hr-and-employee-analytics/resume-screening-analytics/resume_screening_analytics.py
```
