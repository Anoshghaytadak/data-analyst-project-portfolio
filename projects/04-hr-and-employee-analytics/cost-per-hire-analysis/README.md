...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cost-per-Hire Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/cost-per-hire-analysis/cost_per_hire_analysis.py
```
