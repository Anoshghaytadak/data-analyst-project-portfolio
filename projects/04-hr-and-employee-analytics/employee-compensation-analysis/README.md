...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Compensation Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-compensation-analysis/employee_compensation_analysis.py
```
