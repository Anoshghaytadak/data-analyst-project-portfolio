...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Workforce Planning Dashboard**?
...
```bash
python3 projects/04-hr-and-employee-analytics/workforce-planning-dashboard/workforce_planning_dashboard.py
```
