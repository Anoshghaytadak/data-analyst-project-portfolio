...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Promotion Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-promotion-analysis/employee_promotion_analysis.py
```
