...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Recruitment Analytics**?
...
```bash
python3 projects/04-hr-and-employee-analytics/recruitment-analytics/recruitment_analytics.py
```
