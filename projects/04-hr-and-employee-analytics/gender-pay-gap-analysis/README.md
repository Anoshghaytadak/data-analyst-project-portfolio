...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Gender Pay Gap Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/gender-pay-gap-analysis/gender_pay_gap_analysis.py
```
