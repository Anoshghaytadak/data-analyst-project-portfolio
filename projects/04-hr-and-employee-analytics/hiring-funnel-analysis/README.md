...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hiring Funnel Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/hiring-funnel-analysis/hiring_funnel_analysis.py
```
