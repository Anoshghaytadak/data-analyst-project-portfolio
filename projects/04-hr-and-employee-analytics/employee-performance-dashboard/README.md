...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Performance Dashboard**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-performance-dashboard/employee_performance_dashboard.py
```
