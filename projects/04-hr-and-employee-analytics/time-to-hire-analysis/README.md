...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Time-to-Hire Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/time-to-hire-analysis/time_to_hire_analysis.py
```
