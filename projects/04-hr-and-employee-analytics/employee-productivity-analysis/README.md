...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Productivity Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-productivity-analysis/employee_productivity_analysis.py
```
