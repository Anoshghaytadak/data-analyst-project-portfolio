...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Engagement Dashboard**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-engagement-dashboard/employee_engagement_dashboard.py
```
