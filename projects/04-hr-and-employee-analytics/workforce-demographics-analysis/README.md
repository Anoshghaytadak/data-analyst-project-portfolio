...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Workforce Demographics Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/workforce-demographics-analysis/workforce_demographics_analysis.py
```
