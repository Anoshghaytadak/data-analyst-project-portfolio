...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Churn Prediction**?
...
```bash
python3 projects/04-hr-and-employee-analytics/employee-churn-prediction/employee_churn_prediction.py
```
