...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Training & Development Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/training-and-development-analysis/training_and_development_analysis.py
```
