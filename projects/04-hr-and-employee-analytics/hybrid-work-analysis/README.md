...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hybrid Work Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/hybrid-work-analysis/hybrid_work_analysis.py
```
