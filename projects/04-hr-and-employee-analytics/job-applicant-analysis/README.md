...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Job Applicant Analysis**?
...
```bash
python3 projects/04-hr-and-employee-analytics/job-applicant-analysis/job_applicant_analysis.py
```
