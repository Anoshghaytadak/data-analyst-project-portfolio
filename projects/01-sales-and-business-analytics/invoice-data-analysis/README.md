...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Invoice Data Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/invoice-data-analysis/invoice_data_analysis.py
```
