...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Low-Selling Products Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/low-selling-products-analysis/low_selling_products_analysis.py
```
