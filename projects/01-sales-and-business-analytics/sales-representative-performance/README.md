...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales Representative Performance**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-representative-performance/sales_representative_performance.py
```
