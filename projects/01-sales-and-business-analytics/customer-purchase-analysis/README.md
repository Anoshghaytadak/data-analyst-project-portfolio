...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Purchase Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/customer-purchase-analysis/customer_purchase_analysis.py
```
