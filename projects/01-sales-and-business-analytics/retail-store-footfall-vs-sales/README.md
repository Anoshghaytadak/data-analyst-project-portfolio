...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Store Footfall vs Sales**?
...
```bash
python3 projects/01-sales-and-business-analytics/retail-store-footfall-vs-sales/retail_store_footfall_vs_sales.py
```
