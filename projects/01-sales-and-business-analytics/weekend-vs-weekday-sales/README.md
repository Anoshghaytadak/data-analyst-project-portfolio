...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Weekend vs Weekday Sales**?
...
```bash
python3 projects/01-sales-and-business-analytics/weekend-vs-weekday-sales/weekend_vs_weekday_sales.py
```
