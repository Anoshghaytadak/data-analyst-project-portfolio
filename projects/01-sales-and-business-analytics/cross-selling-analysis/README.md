...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cross-Selling Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/cross-selling-analysis/cross_selling_analysis.py
```
