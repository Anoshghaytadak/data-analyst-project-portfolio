...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Subcategory Profitability Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/subcategory-profitability-analysis/subcategory_profitability_analysis.py
```
