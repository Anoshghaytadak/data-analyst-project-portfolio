...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales Funnel Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-funnel-analysis/sales_funnel_analysis.py
```
