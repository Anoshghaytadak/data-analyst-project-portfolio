...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cost of Goods Sold Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/cost-of-goods-sold-analysis/cost_of_goods_sold_analysis.py
```
