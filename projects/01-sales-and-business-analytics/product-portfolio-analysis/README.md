...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Product Portfolio Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/product-portfolio-analysis/product_portfolio_analysis.py
```
