...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Lifetime Value Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/customer-lifetime-value-analysis/customer_lifetime_value_analysis.py
```
