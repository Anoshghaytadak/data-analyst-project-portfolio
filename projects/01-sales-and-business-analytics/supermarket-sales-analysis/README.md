...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supermarket Sales Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/supermarket-sales-analysis/supermarket_sales_analysis.py
```
