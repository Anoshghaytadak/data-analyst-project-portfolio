...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Discount Impact on Sales**?
...
```bash
python3 projects/01-sales-and-business-analytics/discount-impact-on-sales/discount_impact_on_sales.py
```
