...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales Growth Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-growth-analysis/sales_growth_analysis.py
```
