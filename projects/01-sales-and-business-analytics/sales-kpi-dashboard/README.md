...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales KPI Dashboard**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-kpi-dashboard/sales_kpi_dashboard.py
```
