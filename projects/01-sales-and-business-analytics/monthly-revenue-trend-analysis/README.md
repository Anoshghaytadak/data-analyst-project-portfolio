...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Monthly Revenue Trend Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/monthly-revenue-trend-analysis/monthly_revenue_trend_analysis.py
```
