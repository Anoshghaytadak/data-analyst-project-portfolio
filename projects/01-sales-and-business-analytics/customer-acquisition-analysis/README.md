...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Acquisition Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/customer-acquisition-analysis/customer_acquisition_analysis.py
```
