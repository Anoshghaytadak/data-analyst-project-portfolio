...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Regional Sales Performance**?
...
```bash
python3 projects/01-sales-and-business-analytics/regional-sales-performance/regional_sales_performance.py
```
