...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Average Order Value Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/average-order-value-analysis/average_order_value_analysis.py
```
