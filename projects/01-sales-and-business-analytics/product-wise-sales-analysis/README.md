...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Product-wise Sales Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/product-wise-sales-analysis/product_wise_sales_analysis.py
```
