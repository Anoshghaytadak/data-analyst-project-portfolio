...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Branch-wise Sales Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/branch-wise-sales-analysis/branch_wise_sales_analysis.py
```
