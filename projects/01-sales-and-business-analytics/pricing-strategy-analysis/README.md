...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Pricing Strategy Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/pricing-strategy-analysis/pricing_strategy_analysis.py
```
