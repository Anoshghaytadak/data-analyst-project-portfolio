...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Seasonal Sales Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/seasonal-sales-analysis/seasonal_sales_analysis.py
```
