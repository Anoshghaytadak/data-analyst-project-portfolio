...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Lead-to-Customer Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/lead-to-customer-analysis/lead_to_customer_analysis.py
```
