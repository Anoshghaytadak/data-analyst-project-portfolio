...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Repeat Customer Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/repeat-customer-analysis/repeat_customer_analysis.py
```
