...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Month-over-Month Sales Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/month-over-month-sales-analysis/month_over_month_sales_analysis.py
```
