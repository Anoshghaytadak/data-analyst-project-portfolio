...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales Quota Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-quota-analysis/sales_quota_analysis.py
```
