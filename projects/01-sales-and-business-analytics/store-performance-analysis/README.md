...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Store Performance Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/store-performance-analysis/store_performance_analysis.py
```
