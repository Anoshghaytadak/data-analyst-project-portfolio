...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Order Cancellation Analysis**?
...
```bash
python3 projects/01-sales-and-business-analytics/order-cancellation-analysis/order_cancellation_analysis.py
```
