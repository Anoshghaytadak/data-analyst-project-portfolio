...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sales Forecasting Dashboard**?
...
```bash
python3 projects/01-sales-and-business-analytics/sales-forecasting-dashboard/sales_forecasting_dashboard.py
```
