...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Sales Performance Dashboard**?
...
```bash
python3 projects/01-sales-and-business-analytics/retail-sales-performance-dashboard/retail_sales_performance_dashboard.py
```
