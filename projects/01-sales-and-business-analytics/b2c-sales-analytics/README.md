...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **B2C Sales Analytics**?
...
```bash
python3 projects/01-sales-and-business-analytics/b2c-sales-analytics/b2c_sales_analytics.py
```
