...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Healthcare Supply Chain Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/healthcare-supply-chain-analysis/healthcare_supply_chain_analysis.py
```
