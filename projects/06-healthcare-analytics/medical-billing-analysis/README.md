...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Medical Billing Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/medical-billing-analysis/medical_billing_analysis.py
```
