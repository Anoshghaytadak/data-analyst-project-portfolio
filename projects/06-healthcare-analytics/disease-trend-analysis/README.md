...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Disease Trend Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/disease-trend-analysis/disease_trend_analysis.py
```
