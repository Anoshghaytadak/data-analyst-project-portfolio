...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Medicine Inventory Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/medicine-inventory-analysis/medicine_inventory_analysis.py
```
