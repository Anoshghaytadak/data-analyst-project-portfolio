...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Revenue Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-revenue-analysis/hospital_revenue_analysis.py
```
