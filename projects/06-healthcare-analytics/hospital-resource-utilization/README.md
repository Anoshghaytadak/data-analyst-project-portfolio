...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Resource Utilization**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-resource-utilization/hospital_resource_utilization.py
```
