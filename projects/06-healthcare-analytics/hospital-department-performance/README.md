...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Department Performance**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-department-performance/hospital_department_performance.py
```
