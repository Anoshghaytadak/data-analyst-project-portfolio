...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Ambulance Response Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/ambulance-response-analysis/ambulance_response_analysis.py
```
