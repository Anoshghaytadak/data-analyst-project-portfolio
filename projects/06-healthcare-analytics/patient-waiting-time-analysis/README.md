...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Patient Waiting Time Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/patient-waiting-time-analysis/patient_waiting_time_analysis.py
```
