...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Clinic Performance Dashboard**?
...
```bash
python3 projects/06-healthcare-analytics/clinic-performance-dashboard/clinic_performance_dashboard.py
```
