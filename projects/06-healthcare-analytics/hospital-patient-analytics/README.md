...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Patient Analytics**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-patient-analytics/hospital_patient_analytics.py
```
