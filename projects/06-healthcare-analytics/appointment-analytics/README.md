...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Appointment Analytics**?
...
```bash
python3 projects/06-healthcare-analytics/appointment-analytics/appointment_analytics.py
```
