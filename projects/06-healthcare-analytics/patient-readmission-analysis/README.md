...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Patient Readmission Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/patient-readmission-analysis/patient_readmission_analysis.py
```
