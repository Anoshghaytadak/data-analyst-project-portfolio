...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Operations Dashboard**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-operations-dashboard/hospital_operations_dashboard.py
```
