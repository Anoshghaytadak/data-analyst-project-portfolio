...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hospital Bed Occupancy Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/hospital-bed-occupancy-analysis/hospital_bed_occupancy_analysis.py
```
