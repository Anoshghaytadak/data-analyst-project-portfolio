...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Pharmacy Sales Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/pharmacy-sales-analysis/pharmacy_sales_analysis.py
```
