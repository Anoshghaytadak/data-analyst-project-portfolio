...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Medical Appointment No-Show Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/medical-appointment-no-show-analysis/medical_appointment_no_show_analysis.py
```
