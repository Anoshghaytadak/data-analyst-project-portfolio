...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Healthcare Staff Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/healthcare-staff-analysis/healthcare_staff_analysis.py
```
