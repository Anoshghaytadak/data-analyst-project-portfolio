...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Emergency Room Analytics**?
...
```bash
python3 projects/06-healthcare-analytics/emergency-room-analytics/emergency_room_analytics.py
```
