...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Patient Admission Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/patient-admission-analysis/patient_admission_analysis.py
```
