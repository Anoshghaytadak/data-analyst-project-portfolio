...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Doctor Performance Analysis**?
...
```bash
python3 projects/06-healthcare-analytics/doctor-performance-analysis/doctor_performance_analysis.py
```
