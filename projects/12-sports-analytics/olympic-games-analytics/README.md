...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Olympic Games Analytics**?
...
```bash
python3 projects/12-sports-analytics/olympic-games-analytics/olympic_games_analytics.py
```
