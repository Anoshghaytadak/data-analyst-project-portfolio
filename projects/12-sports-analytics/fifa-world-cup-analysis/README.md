...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **FIFA World Cup Analysis**?
...
```bash
python3 projects/12-sports-analytics/fifa-world-cup-analysis/fifa_world_cup_analysis.py
```
