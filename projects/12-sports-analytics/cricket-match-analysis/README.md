...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cricket Match Analysis**?
...
```bash
python3 projects/12-sports-analytics/cricket-match-analysis/cricket_match_analysis.py
```
