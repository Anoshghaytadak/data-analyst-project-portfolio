...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **T20 Analytics**?
...
```bash
python3 projects/12-sports-analytics/t20-analytics/t20_analytics.py
```
