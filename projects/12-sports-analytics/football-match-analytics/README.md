...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Football Match Analytics**?
...
```bash
python3 projects/12-sports-analytics/football-match-analytics/football_match_analytics.py
```
