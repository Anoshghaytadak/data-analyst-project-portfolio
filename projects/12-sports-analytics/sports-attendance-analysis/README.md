...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Sports Attendance Analysis**?
...
```bash
python3 projects/12-sports-analytics/sports-attendance-analysis/sports_attendance_analysis.py
```
