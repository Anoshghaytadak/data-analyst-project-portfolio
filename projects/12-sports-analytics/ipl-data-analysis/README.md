...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **IPL Data Analysis**?
...
```bash
python3 projects/12-sports-analytics/ipl-data-analysis/ipl_data_analysis.py
```
