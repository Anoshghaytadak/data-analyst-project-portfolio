...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Test Cricket Analytics**?
...
```bash
python3 projects/12-sports-analytics/test-cricket-analytics/test_cricket_analytics.py
```
