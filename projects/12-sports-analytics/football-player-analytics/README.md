...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Football Player Analytics**?
...
```bash
python3 projects/12-sports-analytics/football-player-analytics/football_player_analytics.py
```
