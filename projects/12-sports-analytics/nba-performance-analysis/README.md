...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **NBA Performance Analysis**?
...
```bash
python3 projects/12-sports-analytics/nba-performance-analysis/nba_performance_analysis.py
```
