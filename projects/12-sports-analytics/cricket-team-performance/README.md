...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cricket Team Performance**?
...
```bash
python3 projects/12-sports-analytics/cricket-team-performance/cricket_team_performance.py
```
