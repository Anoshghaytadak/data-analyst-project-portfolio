...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Football Team Performance**?
...
```bash
python3 projects/12-sports-analytics/football-team-performance/football_team_performance.py
```
