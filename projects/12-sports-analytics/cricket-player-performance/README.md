...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cricket Player Performance**?
...
```bash
python3 projects/12-sports-analytics/cricket-player-performance/cricket_player_performance.py
```
