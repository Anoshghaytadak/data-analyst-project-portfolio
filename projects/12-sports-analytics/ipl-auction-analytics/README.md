...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **IPL Auction Analytics**?
...
```bash
python3 projects/12-sports-analytics/ipl-auction-analytics/ipl_auction_analytics.py
```
