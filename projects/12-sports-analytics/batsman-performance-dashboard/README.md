...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Batsman Performance Dashboard**?
...
```bash
python3 projects/12-sports-analytics/batsman-performance-dashboard/batsman_performance_dashboard.py
```
