...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Bowler Performance Dashboard**?
...
```bash
python3 projects/12-sports-analytics/bowler-performance-dashboard/bowler_performance_dashboard.py
```
