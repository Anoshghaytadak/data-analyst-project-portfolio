...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Public Service Performance**?
...
```bash
python3 projects/10-government-and-public-data/public-service-performance/public_service_performance.py
```
