...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **State-wise Development Analysis**?
...
```bash
python3 projects/10-government-and-public-data/state-wise-development-analysis/state_wise_development_analysis.py
```
