...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Public Hospital Analytics**?
...
```bash
python3 projects/10-government-and-public-data/public-hospital-analytics/public_hospital_analytics.py
```
