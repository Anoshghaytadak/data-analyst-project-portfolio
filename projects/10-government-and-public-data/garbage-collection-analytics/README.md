...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Garbage Collection Analytics**?
...
```bash
python3 projects/10-government-and-public-data/garbage-collection-analytics/garbage_collection_analytics.py
```
