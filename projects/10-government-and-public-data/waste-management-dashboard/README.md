...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Waste Management Dashboard**?
...
```bash
python3 projects/10-government-and-public-data/waste-management-dashboard/waste_management_dashboard.py
```
