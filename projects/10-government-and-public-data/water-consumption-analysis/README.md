...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Water Consumption Analysis**?
...
```bash
python3 projects/10-government-and-public-data/water-consumption-analysis/water_consumption_analysis.py
```
