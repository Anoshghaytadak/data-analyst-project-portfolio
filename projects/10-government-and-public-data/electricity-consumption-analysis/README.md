...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Electricity Consumption Analysis**?
...
```bash
python3 projects/10-government-and-public-data/electricity-consumption-analysis/electricity_consumption_analysis.py
```
