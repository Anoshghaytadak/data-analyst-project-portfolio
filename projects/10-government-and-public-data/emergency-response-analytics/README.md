...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Emergency Response Analytics**?
...
```bash
python3 projects/10-government-and-public-data/emergency-response-analytics/emergency_response_analytics.py
```
