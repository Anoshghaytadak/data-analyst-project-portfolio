...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Government School Analytics**?
...
```bash
python3 projects/10-government-and-public-data/government-school-analytics/government_school_analytics.py
```
