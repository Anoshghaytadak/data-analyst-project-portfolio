...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Unemployment Analysis**?
...
```bash
python3 projects/10-government-and-public-data/unemployment-analysis/unemployment_analysis.py
```
