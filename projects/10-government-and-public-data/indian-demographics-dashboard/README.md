...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Indian Demographics Dashboard**?
...
```bash
python3 projects/10-government-and-public-data/indian-demographics-dashboard/indian_demographics_dashboard.py
```
