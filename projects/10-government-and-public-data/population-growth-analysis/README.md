...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Population Growth Analysis**?
...
```bash
python3 projects/10-government-and-public-data/population-growth-analysis/population_growth_analysis.py
```
