...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Government Scheme Analysis**?
...
```bash
python3 projects/10-government-and-public-data/government-scheme-analysis/government_scheme_analysis.py
```
