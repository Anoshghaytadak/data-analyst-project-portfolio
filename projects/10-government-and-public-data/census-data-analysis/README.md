...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Census Data Analysis**?
...
```bash
python3 projects/10-government-and-public-data/census-data-analysis/census_data_analysis.py
```
