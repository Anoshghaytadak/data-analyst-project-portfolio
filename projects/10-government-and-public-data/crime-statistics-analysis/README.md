...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Crime Statistics Analysis**?
...
```bash
python3 projects/10-government-and-public-data/crime-statistics-analysis/crime_statistics_analysis.py
```
