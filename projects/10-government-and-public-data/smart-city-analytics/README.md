...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Smart City Analytics**?
...
```bash
python3 projects/10-government-and-public-data/smart-city-analytics/smart_city_analytics.py
```
