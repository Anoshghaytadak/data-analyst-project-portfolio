...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Segmentation Using Clustering**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/customer-segmentation-using-clustering/customer_segmentation_using_clustering.py
```
