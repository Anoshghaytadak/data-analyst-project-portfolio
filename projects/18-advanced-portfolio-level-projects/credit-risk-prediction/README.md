...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Credit Risk Prediction**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/credit-risk-prediction/credit_risk_prediction.py
```
