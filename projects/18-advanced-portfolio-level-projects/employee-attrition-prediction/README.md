...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Employee Attrition Prediction**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/employee-attrition-prediction/employee_attrition_prediction.py
```
