...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **RFM Customer Segmentation**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/rfm-customer-segmentation/rfm_customer_segmentation.py
```
