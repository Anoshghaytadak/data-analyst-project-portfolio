...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Executive Business Intelligence Dashboard**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/executive-business-intelligence-dashboard/executive_business_intelligence_dashboard.py
```
