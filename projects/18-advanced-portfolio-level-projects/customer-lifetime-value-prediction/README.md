...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Lifetime Value Prediction**?
...
```bash
python3 projects/18-advanced-portfolio-level-projects/18-advanced-portfolio-level-projects/customer-lifetime-value-prediction/customer_lifetime_value_prediction.py
```
