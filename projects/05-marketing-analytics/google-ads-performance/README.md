...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Google Ads Performance**?
...
```bash
python3 projects/05-marketing-analytics/google-ads-performance/google_ads_performance.py
```
