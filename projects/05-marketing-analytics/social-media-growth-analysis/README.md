...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Social Media Growth Analysis**?
...
```bash
python3 projects/05-marketing-analytics/social-media-growth-analysis/social_media_growth_analysis.py
```
