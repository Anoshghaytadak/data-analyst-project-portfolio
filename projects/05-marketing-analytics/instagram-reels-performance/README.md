...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Instagram Reels Performance**?
...
```bash
python3 projects/05-marketing-analytics/instagram-reels-performance/instagram_reels_performance.py
```
