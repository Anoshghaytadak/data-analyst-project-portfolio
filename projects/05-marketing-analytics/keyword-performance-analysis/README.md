...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Keyword Performance Analysis**?
...
```bash
python3 projects/05-marketing-analytics/keyword-performance-analysis/keyword_performance_analysis.py
```
