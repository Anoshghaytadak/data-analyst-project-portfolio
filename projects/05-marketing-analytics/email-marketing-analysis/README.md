...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Email Marketing Analysis**?
...
```bash
python3 projects/05-marketing-analytics/email-marketing-analysis/email_marketing_analysis.py
```
