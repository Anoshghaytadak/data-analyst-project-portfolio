...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Social Media Sentiment Analysis**?
...
```bash
python3 projects/05-marketing-analytics/social-media-sentiment-analysis/social_media_sentiment_analysis.py
```
