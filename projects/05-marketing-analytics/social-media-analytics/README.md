...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Social Media Analytics**?
...
```bash
python3 projects/05-marketing-analytics/social-media-analytics/social_media_analytics.py
```
