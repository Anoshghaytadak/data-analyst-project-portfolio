...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Marketing Funnel Analysis**?
...
```bash
python3 projects/05-marketing-analytics/marketing-funnel-analysis/marketing_funnel_analysis.py
```
