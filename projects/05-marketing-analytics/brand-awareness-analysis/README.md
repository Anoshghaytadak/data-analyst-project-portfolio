...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Brand Awareness Analysis**?
...
```bash
python3 projects/05-marketing-analytics/brand-awareness-analysis/brand_awareness_analysis.py
```
