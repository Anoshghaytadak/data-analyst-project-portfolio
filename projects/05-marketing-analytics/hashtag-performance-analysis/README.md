...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Hashtag Performance Analysis**?
...
```bash
python3 projects/05-marketing-analytics/hashtag-performance-analysis/hashtag_performance_analysis.py
```
