...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Lead Generation Analysis**?
...
```bash
python3 projects/05-marketing-analytics/lead-generation-analysis/lead_generation_analysis.py
```
