...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Influencer Marketing Analysis**?
...
```bash
python3 projects/05-marketing-analytics/influencer-marketing-analysis/influencer_marketing_analysis.py
```
