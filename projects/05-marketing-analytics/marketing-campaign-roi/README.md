...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Marketing Campaign ROI**?
...
```bash
python3 projects/05-marketing-analytics/marketing-campaign-roi/marketing_campaign_roi.py
```
