...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Engagement Analysis**?
...
```bash
python3 projects/05-marketing-analytics/customer-engagement-analysis/customer_engagement_analysis.py
```
