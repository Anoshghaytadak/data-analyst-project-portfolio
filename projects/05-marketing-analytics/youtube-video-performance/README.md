...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **YouTube Video Performance**?
...
```bash
python3 projects/05-marketing-analytics/youtube-video-performance/youtube_video_performance.py
```
