...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Website Conversion Analysis**?
...
```bash
python3 projects/05-marketing-analytics/website-conversion-analysis/website_conversion_analysis.py
```
