...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **YouTube Channel Analytics**?
...
```bash
python3 projects/05-marketing-analytics/youtube-channel-analytics/youtube_channel_analytics.py
```
