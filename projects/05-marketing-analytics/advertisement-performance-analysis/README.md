...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Advertisement Performance Analysis**?
...
```bash
python3 projects/05-marketing-analytics/advertisement-performance-analysis/advertisement_performance_analysis.py
```
