...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Acquisition Cost Analysis**?
...
```bash
python3 projects/05-marketing-analytics/customer-acquisition-cost-analysis/customer_acquisition_cost_analysis.py
```
