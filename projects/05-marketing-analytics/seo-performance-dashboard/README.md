...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **SEO Performance Dashboard**?
...
```bash
python3 projects/05-marketing-analytics/seo-performance-dashboard/seo_performance_dashboard.py
```
