...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Facebook Campaign Analysis**?
...
```bash
python3 projects/05-marketing-analytics/facebook-campaign-analysis/facebook_campaign_analysis.py
```
