...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Instagram Engagement Analysis**?
...
```bash
python3 projects/05-marketing-analytics/instagram-engagement-analysis/instagram_engagement_analysis.py
```
