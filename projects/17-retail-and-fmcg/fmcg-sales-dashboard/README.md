...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **FMCG Sales Dashboard**?
...
```bash
python3 projects/17-retail-and-fmcg/fmcg-sales-dashboard/fmcg_sales_dashboard.py
```
