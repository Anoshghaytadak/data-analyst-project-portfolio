...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Inventory Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-inventory-analysis/retail_inventory_analysis.py
```
