...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Grocery Store Analytics**?
...
```bash
python3 projects/17-retail-and-fmcg/grocery-store-analytics/grocery_store_analytics.py
```
