...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **FMCG Distribution Analytics**?
...
```bash
python3 projects/17-retail-and-fmcg/fmcg-distribution-analytics/fmcg_distribution_analytics.py
```
