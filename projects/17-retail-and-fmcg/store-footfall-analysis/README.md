...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Store Footfall Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/store-footfall-analysis/store_footfall_analysis.py
```
