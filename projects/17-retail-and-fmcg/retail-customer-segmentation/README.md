...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Customer Segmentation**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-customer-segmentation/retail_customer_segmentation.py
```
