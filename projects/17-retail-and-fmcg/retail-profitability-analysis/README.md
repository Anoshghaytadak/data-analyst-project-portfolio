...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Profitability Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-profitability-analysis/retail_profitability_analysis.py
```
