...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Supermarket Customer Analytics**?
...
```bash
python3 projects/17-retail-and-fmcg/supermarket-customer-analytics/supermarket_customer_analytics.py
```
