...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Product Demand Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/product-demand-analysis/product_demand_analysis.py
```
