...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Basket Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-basket-analysis/retail_basket_analysis.py
```
