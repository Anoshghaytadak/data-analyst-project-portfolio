...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Brand Performance Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/brand-performance-analysis/brand_performance_analysis.py
```
