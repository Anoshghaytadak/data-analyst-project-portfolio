...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Pricing Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-pricing-analysis/retail_pricing_analysis.py
```
