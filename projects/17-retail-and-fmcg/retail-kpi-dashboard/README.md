...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail KPI Dashboard**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-kpi-dashboard/retail_kpi_dashboard.py
```
