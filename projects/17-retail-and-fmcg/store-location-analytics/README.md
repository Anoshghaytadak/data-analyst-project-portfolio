...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Store Location Analytics**?
...
```bash
python3 projects/17-retail-and-fmcg/store-location-analytics/store_location_analytics.py
```
