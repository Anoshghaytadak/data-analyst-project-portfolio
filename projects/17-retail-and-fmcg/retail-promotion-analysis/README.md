...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Retail Promotion Analysis**?
...
```bash
python3 projects/17-retail-and-fmcg/retail-promotion-analysis/retail_promotion_analysis.py
```
