...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Exam Result Analysis**?
...
```bash
python3 projects/09-education-analytics/exam-result-analysis/exam_result_analysis.py
```
