...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Library Usage Analysis**?
...
```bash
python3 projects/09-education-analytics/library-usage-analysis/library_usage_analysis.py
```
