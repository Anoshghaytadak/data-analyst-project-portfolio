...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **College Placement Dashboard**?
...
```bash
python3 projects/09-education-analytics/college-placement-dashboard/college_placement_dashboard.py
```
