...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Enrollment Analysis**?
...
```bash
python3 projects/09-education-analytics/student-enrollment-analysis/student_enrollment_analysis.py
```
