...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Career Analytics**?
...
```bash
python3 projects/09-education-analytics/student-career-analytics/student_career_analytics.py
```
