...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Campus Connect Analytics**?
...
```bash
python3 projects/09-education-analytics/campus-connect-analytics/campus_connect_analytics.py
```
