...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Education KPI Dashboard**?
...
```bash
python3 projects/09-education-analytics/education-kpi-dashboard/education_kpi_dashboard.py
```
