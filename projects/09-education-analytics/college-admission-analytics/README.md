...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **College Admission Analytics**?
...
```bash
python3 projects/09-education-analytics/college-admission-analytics/college_admission_analytics.py
```
