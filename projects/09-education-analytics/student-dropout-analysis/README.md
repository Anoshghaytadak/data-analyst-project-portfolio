...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Dropout Analysis**?
...
```bash
python3 projects/09-education-analytics/student-dropout-analysis/student_dropout_analysis.py
```
