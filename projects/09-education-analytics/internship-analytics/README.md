...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Internship Analytics**?
...
```bash
python3 projects/09-education-analytics/internship-analytics/internship_analytics.py
```
