...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **College Event Analytics**?
...
```bash
python3 projects/09-education-analytics/college-event-analytics/college_event_analytics.py
```
