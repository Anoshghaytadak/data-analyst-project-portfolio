...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Course Performance Analysis**?
...
```bash
python3 projects/09-education-analytics/course-performance-analysis/course_performance_analysis.py
```
