...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Online Course Completion Analysis**?
...
```bash
python3 projects/09-education-analytics/online-course-completion-analysis/online_course_completion_analysis.py
```
