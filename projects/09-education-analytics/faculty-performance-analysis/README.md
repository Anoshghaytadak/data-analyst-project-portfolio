...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Faculty Performance Analysis**?
...
```bash
python3 projects/09-education-analytics/faculty-performance-analysis/faculty_performance_analysis.py
```
