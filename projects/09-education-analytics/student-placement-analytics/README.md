...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Placement Analytics**?
...
```bash
python3 projects/09-education-analytics/student-placement-analytics/student_placement_analytics.py
```
