...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Attendance Dashboard**?
...
```bash
python3 projects/09-education-analytics/student-attendance-dashboard/student_attendance_dashboard.py
```
