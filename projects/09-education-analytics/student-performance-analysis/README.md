...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Performance Analysis**?
...
```bash
python3 projects/09-education-analytics/student-performance-analysis/student_performance_analysis.py
```
