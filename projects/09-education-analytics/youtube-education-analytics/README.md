...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **YouTube Education Analytics**?
...
```bash
python3 projects/09-education-analytics/youtube-education-analytics/youtube_education_analytics.py
```
