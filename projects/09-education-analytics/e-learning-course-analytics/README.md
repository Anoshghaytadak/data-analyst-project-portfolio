...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-learning Course Analytics**?
...
```bash
python3 projects/09-education-analytics/e-learning-course-analytics/e_learning_course_analytics.py
```
