...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **College Infrastructure Analysis**?
...
```bash
python3 projects/09-education-analytics/college-infrastructure-analysis/college_infrastructure_analysis.py
```
