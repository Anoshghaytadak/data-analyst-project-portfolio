...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Scholarship Analytics**?
...
```bash
python3 projects/09-education-analytics/scholarship-analytics/scholarship_analytics.py
```
