...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Student Engagement Analysis**?
...
```bash
python3 projects/09-education-analytics/student-engagement-analysis/student_engagement_analysis.py
```
