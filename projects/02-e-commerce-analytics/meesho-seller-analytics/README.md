...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Meesho Seller Analytics**?
...
```bash
python3 projects/02-e-commerce-analytics/meesho-seller-analytics/meesho_seller_analytics.py
```
