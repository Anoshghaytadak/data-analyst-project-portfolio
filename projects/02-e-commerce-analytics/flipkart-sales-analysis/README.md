...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flipkart Sales Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/flipkart-sales-analysis/flipkart_sales_analysis.py
```
