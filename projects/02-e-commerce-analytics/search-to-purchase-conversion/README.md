...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Search-to-Purchase Conversion**?
...
```bash
python3 projects/02-e-commerce-analytics/search-to-purchase-conversion/search_to_purchase_conversion.py
```
