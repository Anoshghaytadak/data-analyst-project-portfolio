...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Product Review Sentiment Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/product-review-sentiment-analysis/product_review_sentiment_analysis.py
```
