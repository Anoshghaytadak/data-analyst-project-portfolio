...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Return Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-return-analysis/e_commerce_return_analysis.py
```
