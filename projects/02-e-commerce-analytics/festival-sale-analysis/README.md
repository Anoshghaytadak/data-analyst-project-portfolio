...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Festival Sale Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/festival-sale-analysis/festival_sale_analysis.py
```
