...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Online Shopping Trends**?
...
```bash
python3 projects/02-e-commerce-analytics/online-shopping-trends/online_shopping_trends.py
```
