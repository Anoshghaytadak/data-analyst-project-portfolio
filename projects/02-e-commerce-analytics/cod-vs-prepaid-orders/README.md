...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **COD vs Prepaid Orders**?
...
```bash
python3 projects/02-e-commerce-analytics/cod-vs-prepaid-orders/cod_vs_prepaid_orders.py
```
