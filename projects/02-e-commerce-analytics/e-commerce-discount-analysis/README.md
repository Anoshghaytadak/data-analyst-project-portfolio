...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Discount Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-discount-analysis/e_commerce_discount_analysis.py
```
