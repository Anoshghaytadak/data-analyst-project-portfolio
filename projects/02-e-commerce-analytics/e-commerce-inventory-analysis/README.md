...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Inventory Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-inventory-analysis/e_commerce_inventory_analysis.py
```
