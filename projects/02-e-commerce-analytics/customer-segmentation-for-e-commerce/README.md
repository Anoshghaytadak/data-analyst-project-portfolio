...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Segmentation for E-commerce**?
...
```bash
python3 projects/02-e-commerce-analytics/customer-segmentation-for-e-commerce/customer_segmentation_for_e_commerce.py
```
