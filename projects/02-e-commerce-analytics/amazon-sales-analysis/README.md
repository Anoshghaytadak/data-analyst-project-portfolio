...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Amazon Sales Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/amazon-sales-analysis/amazon_sales_analysis.py
```
