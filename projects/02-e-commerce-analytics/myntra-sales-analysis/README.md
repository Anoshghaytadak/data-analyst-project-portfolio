...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Myntra Sales Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/myntra-sales-analysis/myntra_sales_analysis.py
```
