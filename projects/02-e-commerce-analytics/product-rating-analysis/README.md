...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Product Rating Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/product-rating-analysis/product_rating_analysis.py
```
