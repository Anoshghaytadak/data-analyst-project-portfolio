...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Customer Behavior**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-customer-behavior/e_commerce_customer_behavior.py
```
