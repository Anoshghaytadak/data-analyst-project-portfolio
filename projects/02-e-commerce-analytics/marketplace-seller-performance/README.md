...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Marketplace Seller Performance**?
...
```bash
python3 projects/02-e-commerce-analytics/marketplace-seller-performance/marketplace_seller_performance.py
```
