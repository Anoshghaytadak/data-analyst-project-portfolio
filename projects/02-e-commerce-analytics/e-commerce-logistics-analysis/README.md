...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Logistics Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-logistics-analysis/e_commerce_logistics_analysis.py
```
