...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Cart Abandonment**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-cart-abandonment/e_commerce_cart_abandonment.py
```
