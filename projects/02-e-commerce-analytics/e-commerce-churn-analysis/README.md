...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Churn Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-churn-analysis/e_commerce_churn_analysis.py
```
