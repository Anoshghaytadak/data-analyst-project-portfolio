...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flash Sale Performance**?
...
```bash
python3 projects/02-e-commerce-analytics/flash-sale-performance/flash_sale_performance.py
```
