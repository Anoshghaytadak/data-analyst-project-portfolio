...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Product Recommendation Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-product-recommendation-analysis/e_commerce_product_recommendation_analysis.py
```
