...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Online Purchase Frequency**?
...
```bash
python3 projects/02-e-commerce-analytics/online-purchase-frequency/online_purchase_frequency.py
```
