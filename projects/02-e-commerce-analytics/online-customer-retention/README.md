...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Online Customer Retention**?
...
```bash
python3 projects/02-e-commerce-analytics/online-customer-retention/online_customer_retention.py
```
