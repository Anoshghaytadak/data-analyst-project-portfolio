...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Coupon Usage Analysis**?
...
```bash
python3 projects/02-e-commerce-analytics/coupon-usage-analysis/coupon_usage_analysis.py
```
