...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Website Traffic vs Sales**?
...
```bash
python3 projects/02-e-commerce-analytics/website-traffic-vs-sales/website_traffic_vs_sales.py
```
