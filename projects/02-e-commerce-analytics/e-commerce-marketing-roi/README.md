...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-commerce Marketing ROI**?
...
```bash
python3 projects/02-e-commerce-analytics/e-commerce-marketing-roi/e_commerce_marketing_roi.py
```
