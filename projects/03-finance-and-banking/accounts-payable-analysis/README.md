...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Accounts Payable Analysis**?
...
```bash
python3 projects/03-finance-and-banking/accounts-payable-analysis/accounts_payable_analysis.py
```
