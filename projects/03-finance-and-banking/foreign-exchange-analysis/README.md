...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Foreign Exchange Analysis**?
...
```bash
python3 projects/03-finance-and-banking/foreign-exchange-analysis/foreign_exchange_analysis.py
```
