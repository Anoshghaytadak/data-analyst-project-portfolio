...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Accounts Receivable Analysis**?
...
```bash
python3 projects/03-finance-and-banking/accounts-receivable-analysis/accounts_receivable_analysis.py
```
