...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Banking Product Profitability**?
...
```bash
python3 projects/03-finance-and-banking/banking-product-profitability/banking_product_profitability.py
```
