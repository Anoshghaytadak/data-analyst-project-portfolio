...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **SIP Investment Analysis**?
...
```bash
python3 projects/03-finance-and-banking/sip-investment-analysis/sip_investment_analysis.py
```
