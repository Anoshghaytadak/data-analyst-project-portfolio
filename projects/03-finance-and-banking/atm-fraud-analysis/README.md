...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **ATM Fraud Analysis**?
...
```bash
python3 projects/03-finance-and-banking/atm-fraud-analysis/atm_fraud_analysis.py
```
