...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cash Flow Analysis**?
...
```bash
python3 projects/03-finance-and-banking/cash-flow-analysis/cash_flow_analysis.py
```
