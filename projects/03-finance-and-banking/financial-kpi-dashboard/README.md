...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Financial KPI Dashboard**?
...
```bash
python3 projects/03-finance-and-banking/financial-kpi-dashboard/financial_kpi_dashboard.py
```
