...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **EMI Payment Analysis**?
...
```bash
python3 projects/03-finance-and-banking/emi-payment-analysis/emi_payment_analysis.py
```
