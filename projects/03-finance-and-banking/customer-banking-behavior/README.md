...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Customer Banking Behavior**?
...
```bash
python3 projects/03-finance-and-banking/customer-banking-behavior/customer_banking_behavior.py
```
