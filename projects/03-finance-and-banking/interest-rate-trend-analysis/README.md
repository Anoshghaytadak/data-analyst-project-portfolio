...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Interest Rate Trend Analysis**?
...
```bash
python3 projects/03-finance-and-banking/interest-rate-trend-analysis/interest_rate_trend_analysis.py
```
