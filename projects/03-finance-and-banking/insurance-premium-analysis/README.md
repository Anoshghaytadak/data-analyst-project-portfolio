...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Insurance Premium Analysis**?
...
```bash
python3 projects/03-finance-and-banking/insurance-premium-analysis/insurance_premium_analysis.py
```
