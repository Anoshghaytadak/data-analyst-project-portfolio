...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cryptocurrency Market Analysis**?
...
```bash
python3 projects/03-finance-and-banking/cryptocurrency-market-analysis/cryptocurrency_market_analysis.py
```
