...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Loan Default Analysis**?
...
```bash
python3 projects/03-finance-and-banking/loan-default-analysis/loan_default_analysis.py
```
