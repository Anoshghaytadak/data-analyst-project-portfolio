...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Corporate Finance Dashboard**?
...
```bash
python3 projects/03-finance-and-banking/corporate-finance-dashboard/corporate_finance_dashboard.py
```
