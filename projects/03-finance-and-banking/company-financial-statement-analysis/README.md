...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Company Financial Statement Analysis**?
...
```bash
python3 projects/03-finance-and-banking/company-financial-statement-analysis/company_financial_statement_analysis.py
```
