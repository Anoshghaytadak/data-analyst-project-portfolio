...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Loan Recovery Analysis**?
...
```bash
python3 projects/03-finance-and-banking/loan-recovery-analysis/loan_recovery_analysis.py
```
