...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Inflation Analysis**?
...
```bash
python3 projects/03-finance-and-banking/inflation-analysis/inflation_analysis.py
```
