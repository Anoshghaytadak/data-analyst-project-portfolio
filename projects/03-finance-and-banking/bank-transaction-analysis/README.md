...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Bank Transaction Analysis**?
...
```bash
python3 projects/03-finance-and-banking/bank-transaction-analysis/bank_transaction_analysis.py
```
