...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Bank Branch Performance**?
...
```bash
python3 projects/03-finance-and-banking/bank-branch-performance/bank_branch_performance.py
```
