...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Credit Card Spending Analysis**?
...
```bash
python3 projects/03-finance-and-banking/credit-card-spending-analysis/credit_card_spending_analysis.py
```
