...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Credit Card Fraud Analysis**?
...
```bash
python3 projects/03-finance-and-banking/credit-card-fraud-analysis/credit_card_fraud_analysis.py
```
