...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Budget vs Actual Analysis**?
...
```bash
python3 projects/03-finance-and-banking/budget-vs-actual-analysis/budget_vs_actual_analysis.py
```
