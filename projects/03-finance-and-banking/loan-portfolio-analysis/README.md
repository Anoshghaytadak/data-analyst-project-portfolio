...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Loan Portfolio Analysis**?
...
```bash
python3 projects/03-finance-and-banking/loan-portfolio-analysis/loan_portfolio_analysis.py
```
