...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Investment Portfolio Dashboard**?
...
```bash
python3 projects/03-finance-and-banking/investment-portfolio-dashboard/investment_portfolio_dashboard.py
```
