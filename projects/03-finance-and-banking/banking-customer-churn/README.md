...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Banking Customer Churn**?
...
```bash
python3 projects/03-finance-and-banking/banking-customer-churn/banking_customer_churn.py
```
