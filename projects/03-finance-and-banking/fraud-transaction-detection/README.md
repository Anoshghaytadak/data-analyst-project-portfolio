...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Fraud Transaction Detection**?
...
```bash
python3 projects/03-finance-and-banking/fraud-transaction-detection/fraud_transaction_detection.py
```
