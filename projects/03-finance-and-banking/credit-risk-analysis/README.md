...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Credit Risk Analysis**?
...
```bash
python3 projects/03-finance-and-banking/credit-risk-analysis/credit_risk_analysis.py
```
