...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Metro Passenger Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/metro-passenger-analysis/metro_passenger_analysis.py
```
