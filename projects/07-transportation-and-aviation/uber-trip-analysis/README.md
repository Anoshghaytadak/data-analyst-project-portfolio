...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Uber Trip Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/uber-trip-analysis/uber_trip_analysis.py
```
