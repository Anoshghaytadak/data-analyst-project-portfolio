...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Domestic Flight Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/domestic-flight-analysis/domestic_flight_analysis.py
```
