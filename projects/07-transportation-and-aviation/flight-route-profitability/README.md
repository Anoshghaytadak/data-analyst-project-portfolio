...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flight Route Profitability**?
...
```bash
python3 projects/07-transportation-and-aviation/flight-route-profitability/flight_route_profitability.py
```
