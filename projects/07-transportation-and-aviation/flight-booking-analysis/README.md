...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flight Booking Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/flight-booking-analysis/flight_booking_analysis.py
```
