...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Bus Route Performance**?
...
```bash
python3 projects/07-transportation-and-aviation/bus-route-performance/bus_route_performance.py
```
