...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Ride Cancellation Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/ride-cancellation-analysis/ride_cancellation_analysis.py
```
