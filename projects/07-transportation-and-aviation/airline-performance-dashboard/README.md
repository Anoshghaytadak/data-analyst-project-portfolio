...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Airline Performance Dashboard**?
...
```bash
python3 projects/07-transportation-and-aviation/airline-performance-dashboard/airline_performance_dashboard.py
```
