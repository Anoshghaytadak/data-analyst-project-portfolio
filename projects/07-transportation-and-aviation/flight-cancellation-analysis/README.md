...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flight Cancellation Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/flight-cancellation-analysis/flight_cancellation_analysis.py
```
