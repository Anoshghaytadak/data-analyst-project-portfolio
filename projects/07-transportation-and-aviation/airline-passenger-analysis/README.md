...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Airline Passenger Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/airline-passenger-analysis/airline_passenger_analysis.py
```
