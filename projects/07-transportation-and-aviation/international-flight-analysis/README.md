...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **International Flight Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/international-flight-analysis/international_flight_analysis.py
```
