...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Flight Demand Forecasting**?
...
```bash
python3 projects/07-transportation-and-aviation/flight-demand-forecasting/flight_demand_forecasting.py
```
