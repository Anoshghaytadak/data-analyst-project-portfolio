...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Train Delay Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/train-delay-analysis/train_delay_analysis.py
```
