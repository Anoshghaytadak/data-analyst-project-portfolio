...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Cab Booking Analysis**?
...
```bash
python3 projects/07-transportation-and-aviation/cab-booking-analysis/cab_booking_analysis.py
```
