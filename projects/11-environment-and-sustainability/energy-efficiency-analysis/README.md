...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Energy Efficiency Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/energy-efficiency-analysis/energy_efficiency_analysis.py
```
