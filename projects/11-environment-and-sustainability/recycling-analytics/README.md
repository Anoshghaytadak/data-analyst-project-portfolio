...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Recycling Analytics**?
...
```bash
python3 projects/11-environment-and-sustainability/recycling-analytics/recycling_analytics.py
```
