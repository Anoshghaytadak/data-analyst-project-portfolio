...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Temperature Trend Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/temperature-trend-analysis/temperature_trend_analysis.py
```
