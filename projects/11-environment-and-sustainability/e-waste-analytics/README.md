...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **E-Waste Analytics**?
...
```bash
python3 projects/11-environment-and-sustainability/e-waste-analytics/e_waste_analytics.py
```
