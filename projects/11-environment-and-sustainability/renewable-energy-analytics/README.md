...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Renewable Energy Analytics**?
...
```bash
python3 projects/11-environment-and-sustainability/renewable-energy-analytics/renewable_energy_analytics.py
```
