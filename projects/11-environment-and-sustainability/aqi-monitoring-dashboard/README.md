...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **AQI Monitoring Dashboard**?
...
```bash
python3 projects/11-environment-and-sustainability/aqi-monitoring-dashboard/aqi_monitoring_dashboard.py
```
