...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Rainfall Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/rainfall-analysis/rainfall_analysis.py
```
