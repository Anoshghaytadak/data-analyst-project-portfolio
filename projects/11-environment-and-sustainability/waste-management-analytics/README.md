...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Waste Management Analytics**?
...
```bash
python3 projects/11-environment-and-sustainability/waste-management-analytics/waste_management_analytics.py
```
