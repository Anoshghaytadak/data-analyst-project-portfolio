...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Greenhouse Gas Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/greenhouse-gas-analysis/greenhouse_gas_analysis.py
```
