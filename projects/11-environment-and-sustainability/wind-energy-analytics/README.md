...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Wind Energy Analytics**?
...
```bash
python3 projects/11-environment-and-sustainability/wind-energy-analytics/wind_energy_analytics.py
```
