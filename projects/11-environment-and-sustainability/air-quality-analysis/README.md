...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Air Quality Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/air-quality-analysis/air_quality_analysis.py
```
