...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Carbon Emission Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/carbon-emission-analysis/carbon_emission_analysis.py
```
