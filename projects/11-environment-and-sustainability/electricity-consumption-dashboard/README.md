...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Electricity Consumption Dashboard**?
...
```bash
python3 projects/11-environment-and-sustainability/electricity-consumption-dashboard/electricity_consumption_dashboard.py
```
