...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Drought Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/drought-analysis/drought_analysis.py
```
