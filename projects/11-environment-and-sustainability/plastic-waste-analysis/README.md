...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Plastic Waste Analysis**?
...
```bash
python3 projects/11-environment-and-sustainability/plastic-waste-analysis/plastic_waste_analysis.py
```
