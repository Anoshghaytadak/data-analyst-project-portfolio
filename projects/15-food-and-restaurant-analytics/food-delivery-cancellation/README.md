...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Food Delivery Cancellation**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/food-delivery-cancellation/food_delivery_cancellation.py
```
