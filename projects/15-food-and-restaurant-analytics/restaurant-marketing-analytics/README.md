...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Marketing Analytics**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-marketing-analytics/restaurant_marketing_analytics.py
```
