...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Rating Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-rating-analysis/restaurant_rating_analysis.py
```
