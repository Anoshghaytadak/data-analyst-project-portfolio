...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Food Waste Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/food-waste-analysis/food_waste_analysis.py
```
