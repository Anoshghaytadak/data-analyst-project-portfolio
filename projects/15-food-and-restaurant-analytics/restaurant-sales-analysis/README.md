...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Sales Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-sales-analysis/restaurant_sales_analysis.py
```
