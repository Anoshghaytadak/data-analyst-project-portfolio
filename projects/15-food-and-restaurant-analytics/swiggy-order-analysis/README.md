...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Swiggy Order Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/swiggy-order-analysis/swiggy_order_analysis.py
```
