...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Profitability Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-profitability-analysis/restaurant_profitability_analysis.py
```
