...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Branch Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-branch-analysis/restaurant_branch_analysis.py
```
