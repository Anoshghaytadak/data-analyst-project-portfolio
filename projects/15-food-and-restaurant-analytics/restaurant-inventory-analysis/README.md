...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Inventory Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-inventory-analysis/restaurant_inventory_analysis.py
```
