...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Food Delivery Analytics**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/food-delivery-analytics/food_delivery_analytics.py
```
