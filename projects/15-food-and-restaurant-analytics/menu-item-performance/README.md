...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Menu Item Performance**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/menu-item-performance/menu_item_performance.py
```
