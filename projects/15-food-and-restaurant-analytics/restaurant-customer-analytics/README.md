...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Restaurant Customer Analytics**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/restaurant-customer-analytics/restaurant_customer_analytics.py
```
