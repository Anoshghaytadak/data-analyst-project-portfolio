...
## Business question
How can an analyst use data to measure performance, identify patterns, and recommend an improvement for **Zomato Restaurant Analysis**?
...
```bash
python3 projects/15-food-and-restaurant-analytics/zomato-restaurant-analysis/zomato_restaurant_analysis.py
```
