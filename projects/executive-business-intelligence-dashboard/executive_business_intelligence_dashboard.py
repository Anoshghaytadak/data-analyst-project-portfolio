"""Starter analysis for Executive Business Intelligence Dashboard."""

from statistics import mean

PROJECT = 'Executive Business Intelligence Dashboard'
CATEGORY = 'Advanced / Portfolio-Level Projects'
